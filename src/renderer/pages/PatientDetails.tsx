...
import { Divider, Grid, Paper, Tab, Tabs, TextField, Typography } from '@material-ui/core';
      ...
      <main className={classes.content}>
        ...
        <div style={{width:'100%'}}>
            ...
            <Grid container spacing={3}>
                ...
                <Grid item xs={12} >
                <Typography style={{color:"grey", fontSize:"0.8em"}}>Date of birth *</Typography>
                <TextField
                    required
                    id="date_of_birth"
                    name="date_of_birth"
       ...
       <div style={{marginTop:"50%", width:"100%"}}><Divider/></div>
